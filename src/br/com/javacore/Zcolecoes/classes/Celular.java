...
public class Celular {
    ...
    //Regras criacao metodo equals
    //Reflexivo = x.equals(x) tem que ser true para tudo que for diferente de null
    //Simetrico para x e y diferentes de null, se x.equals(y) == true logo y.equals(x) tem que ser true
    //Transitividade para x, y, z diferente de null, se x.equals(y) == true, logo y.equals(x) == true e x.equals(z) == true logo y.equals(z) tambem tem que ser true
    ...
    public boolean equals(Object obj) {
        ...
        Celular outroCelulaar = (Celular) obj;
        return IMEI != null && IMEI.equals(outroCelulaar.getIMEI());
    }
